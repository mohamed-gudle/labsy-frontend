    ...
    switch (state.currentStep) {
      ...
      case "print-areas":
        return (
          ...
          state.productData.print_areas.length > 0
        );
      default:
        return false;
    }
    ...
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">
          Create a new base product with print areas for customization
        </p>
      </div>
        ...
        <div className="flex items-center justify-between">
          {STEPS.map((step, index) => {
            ...
            return [
              ...
              >
                <div
                  className={`flex items-center justify-center w-10 h-10 rounded-full border-2 transition-colors ${circleClass}`}
                >
                  <Icon size={20} />
                </div>
            ...
            <ReviewAndSubmit
              ...
              onSubmit={async () => {
                ...
                const schemaData: CompleteProductFormData = {
                  ...state.productData,
                  print_areas:
                    state.productData.print_areas?.map((area) => ({
                      name: area.name,
                ...
                const validation = await completeProductSchema.safeParseAsync(
                  schemaData
                );
