    ...
    try {
      const cleanData = {
        ...
        yearsInBusiness: formData.yearsInBusiness
          ? parseInt(formData.yearsInBusiness as string)
          : undefined,
      };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={cn(
              validationErrors.registrationNumber && "border-red-500"
            )}
          />
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className={cn(
              validationErrors["address.street"] && "border-red-500"
            )}
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={cn(
                validationErrors["address.state"] && "border-red-500"
              )}
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="90210"
              className={cn(
                validationErrors["address.zipCode"] && "border-red-500"
              )}
            />
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={cn(
                validationErrors["address.country"] && "border-red-500"
              )}
            />
...
function ContactInfoStep({ data, onSubmit, onBack }: StepFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const validation = await factoryContactInfoSchema.safeParseAsync(
        formData
      );
      if (!validation.success) {
        const errorMap: Record<string, string> = {};
    ...
    try {
      const cleanData = {
        ...
        monthlyCapacity: formData.monthlyCapacity
          ? parseInt(formData.monthlyCapacity as string)
          : undefined,
      };

      const validation = await factoryCapabilitiesSchema.safeParseAsync(
        cleanData
      );
      if (!validation.success) {
        const errorMap: Record<string, string> = {};
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Select the products you can manufacture
          </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Select your available manufacturing methods
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {techniqueOptions.map((technique) => (
              <div key={technique} className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    handleTechniqueChange(technique, checked as boolean)
                  }
                />
                <Label
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Specify minimum orders for your selected product types
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {formData.productTypes.map((productType) => (
              <div key={productType} className="space-y-2">
                <Label htmlFor={`min-order-${productType}`}>
                  {productType} (units)
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    handleMinimumOrderChange(productType, e.target.value)
                  }
                  placeholder="100"
                />
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="10000"
              className={cn(
                validationErrors.monthlyCapacity && "border-red-500"
              )}
            />
            <p className="text-xs text-gray-500">
              Total units per month across all products
            </p>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Select your quality and compliance certifications
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
        ...
        <div className="space-y-4">
          ...
          <p className="text-sm text-gray-600">
            Select the materials you work with
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
...
function VerificationStep({ data, onSubmit, onBack }: StepFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const validation = await factoryVerificationSchema.safeParseAsync(
        formData
      );
      if (!validation.success) {
        const errorMap: Record<string, string> = {};
      ...
      <div className="space-y-6">
        <div className="text-center mb-6">
          <p className="text-gray-600">
            ...
            These documents help us verify your business and ensure quality
            standards.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <Label className="text-base font-medium">
            Quality Certification Documents (Optional)
          </Label>
          <p className="text-sm text-gray-600">
            Upload certificates for ISO, OEKO-TEX, GOTS, etc.
          </p>
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            ...
            <li>
              • Upon approval, you can start receiving manufacturing requests
            </li>
            <li>
