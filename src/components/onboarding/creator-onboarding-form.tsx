      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-2 w-full">
          ...
          <Select
            ...
            onValueChange={(value) =>
              setValue("preferredLanguage", value as "ar" | "en")
            }
          >
...
function BusinessInfoStep({
  ...
  const onFormSubmit = (formData: z.infer<typeof businessInfoSchema>) => {
    ...
    const filteredSocialMediaLinks = Object.fromEntries(
      Object.entries(formData.socialMediaLinks || {}).filter(
    ...
    const processedData = {
      ...formData,
      socialMediaLinks:
        Object.keys(filteredSocialMediaLinks).length > 0
          ? filteredSocialMediaLinks
          : undefined,
    };
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        <div>
          <Label className="text-base font-medium">
            Social Media Links & Online Presence (Optional)
          </Label>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={cn(
                  errors.socialMediaLinks?.instagram && "border-red-500"
                )}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={cn(
                  errors.socialMediaLinks?.twitter && "border-red-500"
                )}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={cn(
                  errors.socialMediaLinks?.tiktok && "border-red-500"
                )}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className={cn(
                  errors.socialMediaLinks?.youtube && "border-red-500"
                )}
              />
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <Input
                ...
                className={cn(
                  errors.socialMediaLinks?.website && "border-red-500"
                )}
              />
              {errors.socialMediaLinks?.website && (
                <p className="text-sm text-red-600">
                  {errors.socialMediaLinks.website.message}
                </p>
              )}
            </div>
          </div>
...
export function CreatorOnboardingForm({
  ...
  const stepComponents = [PersonalInfoStep, BusinessInfoStep];
