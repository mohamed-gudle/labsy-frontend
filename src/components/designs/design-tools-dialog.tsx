...
import { DesignToolsDialogState } from "@/lib/types/designs";
import { useUploadDesign } from "@/lib/api/designs";
import { validateFile } from "@/utils/designs";
...
interface DesignToolsDialogProps {
  className?: string;
  buttonText?: string;
...
/**
 * Design tools dialog component
 * Provides interface for uploading design files with validation and preview
 */
export const DesignToolsDialog = ({
  className = "",
  buttonText = "Upload Design",
  buttonSize = "default",
}: DesignToolsDialogProps) => {
                ...
                {!state.preview ? (
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-gray-500">
                      PNG, JPEG, SVG • Min 3000x3000px • High Quality
                    </p>
                  </div>
                ) : (
                  <div className="space-y-4">
