...
import { DesignState, PrintableArea } from "@/lib/types/designs";
...
/**
 * Design image layer component for handling individual design elements on canvas
 * Provides drag, resize, rotate functionality within printable area constraints
 */
